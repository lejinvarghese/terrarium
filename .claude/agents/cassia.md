---
name: cassia
description: Daily operations coordinator and morning briefing specialist. Use for creating daily plans, schedule management, calendar integration, weather-aware planning, and time-blocking strategies.
